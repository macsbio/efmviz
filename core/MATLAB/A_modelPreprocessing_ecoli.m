function [model, model_irr, model_irr_woCof] = A_modelPreprocessing_ecoli(modelFileLocation, SFileName, fileNamePrefix)
...
selectedMets = {'h';'h2o';'atp';'pi';'adp';'nad';'ppi';'pppi';'nadh';'nadp';'nadph';'amp';'co2';'coa';'nh4';'o2';'fad';'fadh2';'fe2';'na1';'gdp';'gtp';'udp';'ctp';'utp';'cdp';'fmn';'fmnh2'};
