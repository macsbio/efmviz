...
usecase1_fileName = paste(workDir, "/results/ecolidataForMapping_EFM_18.txt", sep="")
...
aa = selectNodes(nodes = "reaction", by.col = "sbml type")$nodes
rxnNodes = getSelectedNodes()
clearSelection()
